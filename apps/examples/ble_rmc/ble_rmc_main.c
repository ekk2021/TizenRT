...
uint8_t def_ext_adv_data[] = {
	...
	0xd8,
	0xff,//RTK_BT_LE_GAP_ADTYPE_MANUFACTURER_SPECIFIC,
	0xd5, 0x00,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if (argc == 3 && strncmp(argv[2], "cremuladv0", 11) == 0) {
			uint8_t adv_event_prop = 1;//0x13;
			uint32_t adv_interval_int[2] = {160,160};
			...
			RMC_LOG(RMC_SERVER_TAG, "create adv ... ok\n");
		}

		if (argc == 3 && strncmp(argv[2], "cremuladv1", 11) == 0) {
		...
		if (argc == 3 && strncmp(argv[2], "cremuladv2", 11) == 0) {
			uint8_t adv_event_prop = 1;//0x13;
			uint32_t adv_interval_int[2] = {160,160};
			uint8_t own_addr_type = 1;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (argc == 3 && strncmp(argv[2], "delmuladv0", 11) == 0) {
		...
		if (argc == 3 && strncmp(argv[2], "delmuladv1", 11) == 0) {
		...
		if (argc == 3 && strncmp(argv[2], "delmuladv2", 11) == 0) {
			uint8_t adv_handle = 2;
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			ret = ble_server_delete_multi_adv(adv_handle);
			if (ret != BLE_MANAGER_SUCCESS) {
				RMC_LOG(RMC_SERVER_TAG, "Fail to delete adv [%d]\n", ret);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (argc == 3 && strncmp(argv[2], "setmuladv0", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			...
			RMC_LOG(RMC_SERVER_TAG, "Stop set adv data ... ok\n");
		}
		else if (argc == 3 && strncmp(argv[2], "setmuladv1", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			uint8_t adv_data_len = 31;
			uint8_t adv_handle = 1;
		...
		else if (argc == 3 && strncmp(argv[2], "setmuladv2", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			uint8_t adv_handle = 2;
			uint8_t adv_data_len = 31;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (argc == 3 && strncmp(argv[2], "stamuladv0", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			uint8_t adv_handle = 0;
		...
		if (argc == 3 && strncmp(argv[2], "stamuladv1", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			uint8_t adv_handle = 1;
			ret = ble_server_start_multi_adv(adv_handle);
			if (ret != BLE_MANAGER_SUCCESS) {
		...
		if (argc == 3 && strncmp(argv[2], "stamuladv2", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			uint8_t adv_handle = 2;
			ret = ble_server_start_multi_adv(adv_handle);
			if (ret != BLE_MANAGER_SUCCESS) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if (argc == 3 && strncmp(argv[2], "stpmuladv0", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			uint8_t adv_handle = 0;
		...
		if (argc == 3 && strncmp(argv[2], "stpmuladv1", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			uint8_t adv_handle = 1;
			ret = ble_server_stop_multi_adv(adv_handle);
			if (ret != BLE_MANAGER_SUCCESS) {
		...
		if (argc == 3 && strncmp(argv[2], "stpmuladv2", 11) == 0) {
			printf("[######## %s : %d]\n", __FUNCTION__, __LINE__);
			uint8_t adv_handle = 2;
			ret = ble_server_stop_multi_adv(adv_handle);
			if (ret != BLE_MANAGER_SUCCESS) {
